...
struct RendererStateLogic
{
	 ...
	 */
	Callback_StateLogic_InstructCodec_PlayStopPause Method_Play;
	Callback_StateLogic_InstructCodec_PlayStopPause Method_Stop;
	Callback_StateLogic_InstructCodec_PlayStopPause Method_Pause;
	/*
...
void _RSL_HandleTrackChange(struct RendererStateLogic* rsl, int seekFlag, int trackDelta, int endOfTrack)
{
	...
	if (stop != 0)
	{
		...
		RSL_DoStateChange(rsl, MR_State_Stopped);
