...
void SinkRequest_StateChange(enum MR_Enum_States state)
{
		...
		case RLINV_SET_STATE:
			switch (lp)
			{
				case MR_State_Stopped:
					...
					RSL_DoStateChange(The_RendererLogic, MR_State_Stopped);
					break;
				case MR_State_Paused:
					SC_LastCommand = MR_State_Paused;
					RSL_DoStateChange(The_RendererLogic, MR_State_Paused);
					break;
				case MR_State_Playing:
					SC_LastCommand = MR_State_Playing;
					RSL_DoStateChange(The_RendererLogic, MR_State_Playing);
					break;
			}
			break;
