...
int main(void)
{
	...
	/* generate a friendly name that contains the host name */
	memcpy(friendlyname,"Intel RemoteIO Client (",23);
	...
	*/
	...
	UpnpStack = UpnpCreateMicroStack(RemoteIOStackChain, friendlyname, udn, "0000001", 20, 8081);
