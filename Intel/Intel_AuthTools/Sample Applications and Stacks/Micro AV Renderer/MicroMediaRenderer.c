 ...
 */
#define RENDERER_SINKPROTOCOLINFO "http-get:*:audio/mpegurl:*,http-get:*:video/mpegurl:*,http-get:*:audio/mp3:*,http-get:*:audio/mpeg:*,http-get:*:audio/x-ms-wma:*,http-get:*:audio/wma:*,http-get:*:audio/mpeg3:*,http-get:*:video/x-ms-wmv:*,http-get:*:video/x-ms-asf:*,http-get:*:video/x-ms-avi:*,http-get:*:video/mpeg:*"
...
void (*MROnStateChangeRequest) (enum MR_Enum_States state) = NULL;
...
void UpdateAvtLastChange()
{
	...
	if (cp != headerPos)
	{
		...
		#ifdef _DEBUG
		printf("UpdateAvtLastChange(): UpnpSetState_AVTransport_LastChange(%s).\r\n", LastChangeValue);
		#endif
...
{
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_GetCurrentTransportActions(%u);\r\n",InstanceID));
...
{
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_Play(%u,%s);\r\n",InstanceID,Speed));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
	if (MROnStateChangeRequest != NULL) MROnStateChangeRequest(MR_State_Playing);
...
{
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_GetDeviceCapabilities(%u);\r\n",InstanceID));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
...
void UpnpAVTransport_GetMediaInfo(void* upnptoken,unsigned int InstanceID)
{
	...
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_GetMediaInfo(%u);\r\n",InstanceID));
...
{
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_Previous(%u);\r\n",InstanceID));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
...
{
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_Next(%u);\r\n",InstanceID));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
	ASSERT(MROnNextPreviousRequest);
	MROnNextPreviousRequest(1);
...
{
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_GetTransportSettings(%u);\r\n",InstanceID));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
...
{
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_SetAVTransportURI(%u,%s,%s);\r\n",InstanceID,CurrentURI,CurrentURIMetaData));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
...
{
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_Pause(%u);\r\n",InstanceID));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
	if (MROnStateChangeRequest != NULL) MROnStateChangeRequest(MR_State_Paused);
...
void UpnpAVTransport_GetPositionInfo(void* upnptoken,unsigned int InstanceID)
{
	...
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_GetPositionInfo(%u);\r\n",InstanceID));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
...
void UpnpAVTransport_Seek(void* upnptoken,unsigned int InstanceID,char* Unit,char* Target)
{
	...
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_Seek(%u,%s,%s);\r\n",InstanceID,Unit,Target));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
...
{
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_GetTransportInfo(%u);\r\n",InstanceID));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
...
{
	int mode;
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_SetPlayMode(%u,%s);\r\n",InstanceID,NewPlayMode));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
...
{
	VERBOSEONLY(printf("Invoke: UpnpAVTransport_Stop(%u);\r\n",InstanceID));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
	if (MROnStateChangeRequest != NULL) MROnStateChangeRequest(MR_State_Stopped);
...
{
	VERBOSEONLY(printf("Invoke: UpnpConnectionManager_GetCurrentConnectionInfo(%d);\r\n",ConnectionID));
...
{
	VERBOSEONLY(printf("Invoke: UpnpConnectionManager_GetProtocolInfo();\r\n"));
...
{
	VERBOSEONLY(printf("Invoke: UpnpConnectionManager_GetCurrentConnectionIDs();\r\n"));
...
{
	int channel;
	VERBOSEONLY(printf("Invoke: UpnpRenderingControl_SetVolume(%u,%s,%u);\r\n",InstanceID,Channel,DesiredVolume));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
...
{
	int channel;
	VERBOSEONLY(printf("Invoke: UpnpRenderingControl_GetMute(%u,%s);\r\n",InstanceID,Channel));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
	channel = FindStringInArray(Channel,MR_AUDIOCHANNELS,3);
	if (channel == -1) {UpnpResponse_Error(upnptoken,RCS_ERROR_INVALID_CHANNEL,RCS_ERRORSTR_INVALID_CHANNEL);return;}
...
{
	int channel;
	VERBOSEONLY(printf("Invoke: UpnpRenderingControl_SetMute(%u,%s,%d);\r\n",InstanceID,Channel,DesiredMute));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
	channel = FindStringInArray(Channel,MR_AUDIOCHANNELS,3);
	if (channel == -1) {UpnpResponse_Error(upnptoken,RCS_ERROR_INVALID_CHANNEL,RCS_ERRORSTR_INVALID_CHANNEL);return;}
...
{
	int channel;
	VERBOSEONLY(printf("Invoke: UpnpRenderingControl_GetVolume(%u,%s);\r\n",InstanceID,Channel));
	if (InstanceID != 0) {UpnpResponse_Error(upnptoken,AVT_ERROR_INVALID_INSTANCE_ID,AVT_ERRORSTR_INVALID_INSTANCE_ID);return;}
	channel = FindStringInArray(Channel,MR_AUDIOCHANNELS,3);
	if (channel == -1) {UpnpResponse_Error(upnptoken,RCS_ERROR_INVALID_CHANNEL,RCS_ERRORSTR_INVALID_CHANNEL);return;}
