 ...
 *  
 * $Workfile: PPC Media Server.cpp
 * $Revision:
 * $Author: Intel, DPA, Solution Architecture
 * $Date: 10/05/02
 * $Archive:
 *
 * Intel Media Server PocketPC reference application. This file is a
 * shell & user interface on top of the Micro Media Service library.
 * It starts up an instance of a Micro Media Server and shares a
 * single directory and all sub-directories.
 */


// PPC Media Server.cpp : Defines the entry point for the application.
//
